        ...
        <div className="container py-5">
            <ul className="nav nav-tabs" id="myTab" role="tablist">
              ...
              <div className="tab-content" id="myTabContent">
                        ...
                        <div className="row">
                            ...
                            <div className="col-8 mt-5 border p-4">
                                <div className="row">
                                    ...
                                    <div className="col-6 mb-3">
                                        <label htmlFor="birthdate" className="form-label">Gender</label>
                ...
                <div className="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="profile-tab">2...</div>
                            ...
                            <div className="col-8 mt-5 border p-4">
                                <div className="row">
                                    <div className="col-6 mb-3">
                                        ...
                                        <input type="tel" className="form-control" id="" placeholder="New Password" />
                                    </div>  
                                    <div className="col-6 mb-3">
                                        <label htmlFor="" className="form-label">Confirm New Password</label>
                                        <input type="tel" className="form-control" id="" placeholder="Confirm New Password" />
                                    </div>
                                    
                                    <div className="col-6">
                                        <button className="btn btn__bg btn__sqr">Update Password</button>
                                    </div>
